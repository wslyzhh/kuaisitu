...
namespace MettingSys.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        //private string appkey = "dingzreafyvgzklylomj";
        //private string appsecret = "e-PldpQ915MdEYJlL-s3P3kp8Z9HBi1GcaQOHfr39PfgY6AG2lPn16KqgYaMyr3J";

        /// <summary>
        /// 获取access_token
        /// </summary>
        //private string gettoken_url = @"https://oapi.dingtalk.com/gettoken";

        /// <summary>
        /// 获取用户userid
        /// </summary>
        //private string getuserinfo_url = @"https://oapi.dingtalk.com/user/getuserinfo?access_token=access_token&code=code";
        ...
        public BasePage()
        {
            ...
            //OapiGettokenResponse response = getDingTalkAccessToken();
        ...
        public bool IsUserLogin()
        {
            ...
            {
                //检查Cookies
                string username = Utils.GetCookie(DTKeys.COOKIE_USER_NAME_REMEMBER, "MettingSys");
                string password = Utils.GetCookie(DTKeys.COOKIE_USER_PWD_REMEMBER, "MettingSys");
        ...
        #region 钉钉授权
        //private OapiGettokenResponse getDingTalkAccessToken()
        //{
        //    DefaultDingTalkClient client = new DefaultDingTalkClient(gettoken_url);
