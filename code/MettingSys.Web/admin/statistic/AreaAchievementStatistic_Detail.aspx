<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AreaAchievementStatistic_Detail.aspx.cs" Inherits="MettingSys.Web.admin.statistic.AreaAchievementStatistic_Detail" %>
...
<body class="mainbody">
    <form id="ajaxForm" runat="server" action="AreaAchievementStatistic_Detail.aspx" method="post" enctype="multipart/form-data">
        <!--导航栏-->
        ...
        <div class="searchbar">
            <div class="menu-list" style="margin-bottom: 10px;">
                ...
                <a href="<%=Utils.CombUrlTxt("AreaAchievementStatistic_Detail.aspx", "Excel={0}&txtsDate={1}&txteDate={2}&ddllock={3}&ddlstatus={4}&hide_place={5}&cbIsCust={6}&action={7}&ddlorderType={8}&ddlorder={9}&txtOrderID={10}&txtCusName={11}&txtContent={12}&txtAddress={13}", "on", _sMonth, _eMonth, _lockstatus, _status, _area, _isCust,action,_ordertype,_order,_orderNum,_cusName,_content,_address) %>"><i class="iconfont icon-exl"></i><span>导出Excel</span></a>
            </div>
        </div>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%# Eval("p_chnName") %>(<%# Eval("p_ratio") %>%)</td>
                        <td><%# Eval("shou") %></td>
                        <td><%# Eval("unIncome") %></td>
                        <td><%# Eval("fu")%></td>
                        <td><%# Eval("unCost") %></td>
