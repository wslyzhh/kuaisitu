                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                ...
                                <span onmouseover="tip_index=layer.tips('财务审批<br/>审批人：<%#Eval("rpd_checkNum2")%>-<%#Eval("rpd_checkName2")%><br/>审批备注：<%#Eval("rpd_checkRemark2")%><br/>审批时间：<%#Eval("rpd_checkTime2")%>', this, { time: 0 });" onmouseout="layer.close(tip_index);" class="check_<%#Eval("rpd_flag2")%>"></span>
                                <span onmouseover="tip_index=layer.tips('总经理审批<br/>审批人：<%#Eval("rpd_checkNum3")%>-<%#Eval("rpd_checkName3")%><br/>审批备注：<%#Eval("rpd_checkRemark3")%><br/>审批时间：<%#Eval("rpd_checkTime3")%>', this, { time: 0 });" onmouseout="layer.close(tip_index);" class="check_<%#Eval("rpd_flag3")%>"></span>
                            </td>
                            <td>
