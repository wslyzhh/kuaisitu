...
namespace MettingSys.Web.admin.channel
{
    public partial class channel_edit : Web.UI.ManagePage
    {
        ...
        private string GetInherit(string page_type)
        {
            ...
            {
                case "index":
                    result = "MettingSys.Web.UI.Page.article";
                    break;
                case "category":
                    result = "MettingSys.Web.UI.Page.category";
                    break;
                case "list":
                    result = "MettingSys.Web.UI.Page.article_list";
                    break;
                case "detail":
                    result = "MettingSys.Web.UI.Page.article_show";
                    break;
            }
            return result;
        }
