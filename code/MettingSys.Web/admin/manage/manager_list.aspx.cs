    ...
    public partial class manager_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind("role_type>=" + model.role_type + CombSqlTxt(keywords), "user_name asc,m.id desc");
            }
        }
        ...
        protected string CombSqlTxt(string _keywords)
        {
            ...
            {
                strTemp.Append(" and (user_name like  '%" + _keywords + "%' or real_name like '%" + _keywords + "%' or email like '%" + _keywords + "%' or detaildepart like '%" + _keywords + "%')");
            }
        ...
        {
            ChkAdminLevel("sys_usermanage", DTEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.manager bll = new BLL.manager();
