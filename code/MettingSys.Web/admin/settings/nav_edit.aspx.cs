...
namespace MettingSys.Web.admin.settings
{
    public partial class nav_edit : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.navtype = DTRequest.GetQueryStringValue("navtype", "System");
            ...
            if (!Page.IsPostBack)
            {
                ...
                {
                    TreeBind(navtype); //绑定导航菜单
                    this.ddlNavigationType.SelectedValue = this.navtype;
                    if (this.id > 0)
                    {
        ...
        private void ShowInfo(int _id)
        {
            ...
            ddlNavigationType.SelectedValue = model.nav_type;
            TreeBind(model.nav_type); //绑定导航菜单
            ...
            if (model.is_sys == 1)
            {
                ddlNavigationType.Enabled = false;
        ...
        private bool DoAdd()
        {
            try
            {
                ...
                model.nav_type = ddlNavigationType.SelectedValue.Trim();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == DTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改导航菜单成功！", "nav_list.aspx?navtype="+ this.navtype, "parent.loadMenuTree");
            }
            else //添加
            {
                ...
                JscriptMsg("添加导航菜单成功！", "nav_list.aspx?navtype=" + this.navtype, "parent.loadMenuTree");
            }
        }

        protected void ddlNavigationType_SelectedIndexChanged(object sender, EventArgs e)
        {
            this.navtype = ddlNavigationType.SelectedValue;
            TreeBind(this.navtype); //绑定导航菜单
        }
    }
}