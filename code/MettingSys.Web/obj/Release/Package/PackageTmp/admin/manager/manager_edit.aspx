<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_edit.aspx.cs" Inherits="MettingSys.Web.admin.manager.manager_edit" ValidateRequest="false" %>
    ...
    <script type="text/javascript">
        ...
        function choosePermission(obj) {
            ...
            var d = top.dialog({
                ...
                padding: 0,
                title: "选择员工权限",
                url: 'manage/selectPermission.aspx'
            }).showModal();
            //将容器对象传进去
            d.data = liObj;
            d.hcode = $("#hCodeStr");
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>用户名</dt>
                <dd>
                    <asp:TextBox ID="txtUserName" runat="server" CssClass="input normal" datatype="/^[a-zA-Z0-9\-\_]{2,50}$/" sucmsg=" " onkeyup="cToUpper(this)"></asp:TextBox>
            ...
            <dl>
                <dt>直属上级</dt>
                <dd>
                    <asp:TextBox ID="txtLeader" runat="server" CssClass="input small"></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>岗位</dt>
