<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sound_list.aspx.cs" Inherits="MettingSys.Web.admin.weixin.sound_list" ValidateRequest="false" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#Eval("keywords")%></td>
    <td><%#new MettingSys.BLL.weixin_request_content().GetContent(Convert.ToInt32(Eval("id")))%></td>
    <td>
