<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="text_list.aspx.cs" Inherits="MettingSys.Web.admin.weixin.text_list" ValidateRequest="false" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new MettingSys.BLL.weixin_account().GetName(Convert.ToInt32(Eval("account_id")))%></td>
    <td><%#Eval("keywords")%></td>
    <td><%#Utils.DropHTML( new MettingSys.BLL.weixin_request_content().GetContent(Convert.ToInt32(Eval("id"))), 30)%></td>
    <td>
