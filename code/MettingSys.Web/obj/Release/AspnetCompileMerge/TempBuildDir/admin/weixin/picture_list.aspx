<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="picture_list.aspx.cs" Inherits="MettingSys.Web.admin.weixin.picture_list" ValidateRequest="false" %>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center">
      <%#new MettingSys.BLL.weixin_request_content().GetCount(Convert.ToInt32(Eval("id")))%> 条
    </td>
