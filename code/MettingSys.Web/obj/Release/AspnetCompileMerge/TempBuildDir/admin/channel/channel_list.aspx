<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="channel_list.aspx.cs" Inherits="MettingSys.Web.admin.channel.channel_list" ValidateRequest="false" %>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><%#Eval("name")%></td>
      <td><%#Eval("title")%></td>
      <td><%#new MettingSys.BLL.sites().GetTitle(Convert.ToInt32(Eval("site_id")))%></td>
