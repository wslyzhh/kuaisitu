<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nav_list.aspx.cs" Inherits="MettingSys.Web.admin.settings.nav_list" ValidateRequest="false" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="nav_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>&navtype=<%=ddlNavType.SelectedValue.ToString()%>"><i class="iconfont icon-close"></i><span>新增</span></a></li>
        ...
        <div class="menu-list">
          <div class="rule-single-select">
            <asp:DropDownList ID="ddlNavType" runat="server" AutoPostBack="True" onselectedindexchanged="ddlNavType_SelectedIndexChanged">
                <asp:ListItem Value="System">系统后台菜单</asp:ListItem>
                <asp:ListItem Value="OA" Selected="True">商务会展导航[PC终端]</asp:ListItem>
                <asp:ListItem Value="DingTalk">商务会展导航[钉钉终端]</asp:ListItem>
            </asp:DropDownList>
          </div>
        </div>
      </div>
    ...
    <ul>
      ...
      <li class="layer-<%#Eval("class_layer")%>">
        <div class="tbody">
          ...
          <div class="col col-7">
            <a href="nav_edit.aspx?action=<%#DTEnums.ActionEnum.Add %>&id=<%#Eval("id")%>&navtype=<%=ddlNavType.SelectedValue.ToString()%>">添子级</a>
            <a href="nav_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>&navtype=<%=ddlNavType.SelectedValue.ToString()%>">修改</a>
          </div>
        </div>
      </li>
      </ItemTemplate>
