<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nav_edit.aspx.cs" Inherits="MettingSys.Web.admin.settings.nav_edit" ValidateRequest="false" %>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList ID="ddlNavigationType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlNavigationType_SelectedIndexChanged">
            <asp:ListItem Value="System" Selected="True">系统后台菜单</asp:ListItem>
            <asp:ListItem Value="OA">商务会展导航[PC终端]</asp:ListItem>
...
<div class="page-footer">
  <div class="btn-wrap">
    ...
    <input name="btnReturn" type="button" value="返回上一页" class="btn yellow" onclick="javascript: window.location.href = 'nav_list.aspx?navtype=<%=this.navtype%>';" />
  </div>
</div>
<!--/工具栏-->
</form>
