<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="MettingSys.Web.Error" %>
...
<body class="mainbody">
    ...
    <div class="w3layouts-bg">
        <div class="w3layouts-right">
            <div class="w3ls-text">
                <img src="images/error.PNG" style="display: block; float: left;" />
                <div style="float: left;padding-top: 58px;">
                    <h3>我们很抱歉！</h3>
                    <h4 class="w3-agileits2">您请求的页面出错了。请 <a href="center.aspx">返回首页</a> 或 联系管理员。</h4>
                    <p></p>
                </div>
            </div>
        </div>
