<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selfReceipt_list.aspx.cs" Inherits="MettingSys.Web.admin.self.selfReceipt_list" %>
    ...
    <script type="text/javascript">
        ...
        function dealDistribution(id) {
            layer.open({
                ...
                title: '分配收款金额',
                area: ['950px', '650px'],
                content: ['rpDistribution.aspx?id=' + id + '', 'no']
            });
        }
    </script>
    <style type="text/css">
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="searchbar" style="margin-top:10px;">
            ...
            凭证日期：
            <asp:TextBox ID="txtNumDate" runat="server" CssClass="input rule-date-input" Width="120" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
            对账凭证：
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr id="tr<%#Eval("rp_id")%>">
                        ...
                        <td><%# Eval("rp_money") %></td>
                        <td><a href="javascript:;" onclick="showDetail(<%#Eval("rp_id")%>)"><%# Eval("undistribute") %></a></td>
