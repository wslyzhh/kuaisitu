<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="MettingSys.Web.admin.index" %>
    ...
    <div class="nav-right">
      <div class="info">
        ...
        <span>
          ...
          <%=new MettingSys.BLL.manager_role().GetTitle(admin_info.role_id) %>
        </span>
      </div>
      <div class="option">
