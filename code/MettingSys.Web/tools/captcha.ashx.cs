...
namespace MettingSys.Web.tools
{
    ...
    public class captcha : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Session[DTKeys.SESSION_CODE] = code.ToUpper();
        }
        ...
        #region 自定义背景色(默认白色)
        Color backgroundColor = ColorTranslator.FromHtml("#68B71A");
        ...
        #region 自定义随机颜色数组
        //Color[] colors = { Color.Black, Color.White, Color.Red, Color.DarkBlue, Color.Green, Color.Orange, Color.Brown, Color.DarkCyan, Color.Purple };
