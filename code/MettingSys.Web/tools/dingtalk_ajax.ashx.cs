                ...
                if (_type == "check")
                {
                    if (new BLL.permission().checkHasPermission(managerModel, "0603"))//部门审批
                    {
                        ...
                        if (_flag == "0")
                        {
                            if (managerModel.area == new BLL.department().getGroupArea())
                            {
                                strTemp.Append(" and uba_flag1=0");
                            }
                            else
                            {
                                strTemp.Append(" and uba_area='" + managerModel.area + "' and uba_flag1=0");
                            }
                        }
                        else if (_flag == "1")
                        {
                    ...
                    else if (new BLL.permission().checkHasPermission(managerModel, "0402"))//财务审批
                    {
                        ...
                        if (_flag == "0")
                        {
                            strTemp.Append(" and uba_flag1=2 and uba_flag2=0");
                        }
                        else if (_flag == "1")
                        {
                    ...
                    else if (new BLL.permission().checkHasPermission(managerModel, "0601"))//总经理审批
                    {
                        ...
                        if (_flag == "0")
                        {
                            strTemp.Append(" and uba_flag1=2 and uba_flag2=2 and uba_flag3=0");
                        }
                        else if (_flag == "1")
                        {
            ...
            try
            {
                ...
                if (_type == "check")
                {
                    if (new BLL.permission().checkHasPermission(managerModel, "0603"))//部门审批
                    {
                        ...
                        if (_flag == "0")
                        {
                            strTemp.Append(" and rpd_area='" + managerModel.area + "' and rpd_flag1=0");
                        }
                        else if (_flag == "1")
                        {
                    ...
                    else if (new BLL.department().getGroupArea() == managerModel.area && new BLL.permission().checkHasPermission(managerModel, "0402"))//财务审批
                    {
                        ...
                        if (_flag == "0")
                        {
                            strTemp.Append(" and rpd_flag1=2 and rpd_flag2=0");
                        }
                        else if (_flag == "1")
                        {
