...
namespace MettingSys.Model
{
    ...
    public class sysconfig
    {
        ...
        private string _sysencryptstring = "MettingSys";

        private string _messageTemplateUrl = string.Empty;

        private string _CorpId = "ding726072f5107d098b";//企业ID
        private string _AgentId = "263964687";//应用ID
        private string _AppKey = "ding7rwltili6i8qoiwh";
        private string _AppSecret = "9E5xwETR0Kc2_EJsLCNuPALG0K7-xVZvIGB7jTJN7Yd4Q6ZwoS7X0nMnhigtyKbP";
        ...
        {
            get { return _messageTemplateUrl; }
            set { _messageTemplateUrl = value; }
        }
