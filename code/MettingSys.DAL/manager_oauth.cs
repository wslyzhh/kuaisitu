...
namespace MettingSys.DAL
{
    ...
    public partial class manager_oauth
    {
        ...
        public manager_oauth(string _databaseprefix)
        {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from  " + databaseprefix + "manager_oauth");
        ...
        /// 删除一条数据
        /// </summary>
        public bool Delete(SqlConnection conn, SqlTransaction trans, int manager_id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from  " + databaseprefix + "manager_oauth ");
            strSql.Append(" where manager_id=@manager_id");
            SqlParameter[] parameters = {
                    new SqlParameter("@manager_id", SqlDbType.Int,4)};
            parameters[0].Value = manager_id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM " + databaseprefix + "manager_oauth");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update " + databaseprefix + "manager_oauth set " + strValue);
            strSql.Append(" where oauth_name=@oauth_name and oauth_userid=@oauth_userid");
            SqlParameter[] parameters = {
                    new SqlParameter("@oauth_name", SqlDbType.NVarChar,100),
                    new SqlParameter("@oauth_userid", SqlDbType.NVarChar,100)};
            parameters[0].Value = oauth_name;
            parameters[1].Value = oauth_userid;
        ...
        /// 修改一列数据
        /// </summary>
        public bool UpdateField(SqlConnection conn, SqlTransaction trans, int manager_id, string strValue)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update " + databaseprefix + "manager_oauth set " + strValue);
            strSql.Append(" where manager_id=@manager_id");
