...
namespace MettingSys.DAL
{
    public partial class unBusinessMoneyLog
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from  MS_unBusinessMoneyLog");
            strSql.Append(" where ");
            strSql.Append(" ubml_id = @id  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from  MS_unBusinessMoneyLog ");
            strSql.Append(" where ubml_id=@id");
            SqlParameter[] parameters = {
                    new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM MS_unBusinessApply");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
