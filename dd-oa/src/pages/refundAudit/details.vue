    ...
    <div class="body_gery">
        <ul class="form_list form_list_noborder">
            <li class="flex flex_a_c flex_s_b" >
                <label class="title"><span>退款对象</span></label>
                <input type="text" :value="clientName" readonly>
            </li>
            <li class="flex flex_a_c">
                <label class="title"><span>退款金额</span></label>
                <input type="text" v-model="-addData.rpmoney">
            </li>
            <li class="flex flex_a_c flex_s_b">
                <label class="title"><span>预退款日期</span></label>
			...
			<li class="flex flex_a_c flex_s_b">
			    <label class="title"><span>退款方式</span></label>
			    <input type="text" readonly v-model="addData.rp_method_text">
			</li>
            <li class="li_auto flex">
                <label class="title"><span>退款内容</span></label>
        ...
        <top-nav :title='"审批退款"' :text='"保存"' @rightClick="submit" ></top-nav>
    </div>
</template>
